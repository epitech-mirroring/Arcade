...
SnakeGame::SnakeGame()
{
    ...
    this->_background_even = std::make_shared<Square>(RGBAColor(162, 209, 73, 255), GRID_WIDTH, GRID_HEIGHT, false, ' ');
    this->_background_odd = std::make_shared<Square>(RGBAColor(170, 215, 81, 255), GRID_WIDTH, GRID_HEIGHT, false, ' ');
}
